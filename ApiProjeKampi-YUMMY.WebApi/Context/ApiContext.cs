...
namespace ApiProjeKampi_YUMMY.WebApi.Context
{
    public class ApiContext:DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-CT9L3VP\\SQLEXPRESS; initial Catalog=ApiYummyDb; integrated Security=true;");
        }
