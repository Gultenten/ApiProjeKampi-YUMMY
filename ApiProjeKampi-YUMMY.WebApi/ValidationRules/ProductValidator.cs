...
namespace ApiProjeKampi_YUMMY.WebApi.ValidationRules
{
    public class ProductValidator:AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(X => X.Price).NotEmpty().WithMessage("Ürün fiyatı boş geçilemez").GreaterThan(0).WithMessage("Ürün fiyatı " +
               "negatif olamaz").LessThan(1000).WithMessage("Ürün fiyatı bu kadar yüksek olamaz,kontrol ediniz");
