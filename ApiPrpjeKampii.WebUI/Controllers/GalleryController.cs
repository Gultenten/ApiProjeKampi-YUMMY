...
using ApiPrpjeKampii.WebUI.Dtos.ImageDtos;
...
namespace ApiPrpjeKampii.WebUI.Controllers
{
    public class GalleryController : Controller
    {
        ...
        public async Task<IActionResult> ImageList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7129/api/Images");
        ...
        public async Task<IActionResult> CreateImage(CreateImageDto createImageDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7129/api/Images", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7129/api/Images?id=" + id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7129/api/Images/GetImage?id=" + id);
            var jsondata = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateImage(UpdateImageDto updateImageDto)
        {
            ...
            StringContent stringContent = new StringContent(jsondata, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7129/api/Images/", stringContent);
